...
var QUIZ_DETAILED_SUBJECT = 'Synonyms of the word ARTIFACT';

// the time limit, in minutes
var QUIZ_TIME_LIMIT = 5;

// array of all the correct answers
var QUIZ_ANSWERS = ["antiquity", "heirloom", "relic", "deceit", "falsehood", "fiction", "forgery", "myth", "untruth", "art", "craft", "amount", "brand", "commodity", "crop", "device", "fruit", "merchandise", "output", "produce", "production", "profit", "stock", "work", "antique", "antiquity", "curio", "evidence", "fragment", "keepsake", "memento", "monument", "remains", "remnant", "souvenir"];
